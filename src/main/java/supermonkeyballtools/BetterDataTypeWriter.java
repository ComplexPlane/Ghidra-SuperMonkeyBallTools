    ...
    private void doWrite(DataType dt, TaskMonitor monitor, boolean throwExceptionOnInvalidType)
        ...
        if (resolvedType != null) {
            ...
            if (dt instanceof TypeDef) {
                ...
                if (resolvedType instanceof Composite || resolvedType instanceof ghidra.program.model.data.Enum) {
...
//                composite.getDisplayName(), composite.getLength(), EOL));
    ...
    private void writeEnum(ghidra.program.model.data.Enum enumm, TaskMonitor monitor) throws IOException {
